...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<h1 class="my-4">Listado Asignatura</h1>
				<div class="list-group">
					<a href="http://localhost:8080/colegio/listadoasignaturasAL">Listar
						Asignaturas</a>
				</div>
			</div>
			<div class="col-lg-9">
				<div class="row">
					<div class="container">
						<form action="http://localhost:8080/colegio/listadoasignaturasAL"
							method="post">
