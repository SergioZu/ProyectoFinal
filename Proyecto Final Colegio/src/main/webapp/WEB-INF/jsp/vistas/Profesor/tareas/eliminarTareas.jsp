...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<h1 class="my-4">Borrar Tareas</h1>
				<div class="list-group">
					<a href="http://localhost:8080/colegio/listadotareasP">Listar
						Temas</a> <a href="http://localhost:8080/colegio/insertartareasP">Insertar
						Temas</a> <a
			...
			<div class="col-lg-9">
				<div class="row">
					<div class="container">
						<form action="http://localhost:8080/colegio/formularioborrartareasP"
							method="post">
						...
						<c:forEach items="${lista}" var="tareas">
							<div class="form">
								<form action="http://localhost:8080/colegio/borrartareasP"
									method="post">
									...
									<input type="text" id="temas" name=""
										temas""
										value="${ tareas.nombreTema}"> <br>
									<br> <label for="nota">Contenido </label> <input
						...
						<c:if test="${resultado == 1 }">
							<h3>Tarea borrada correctamente</h3>
						</c:if>
