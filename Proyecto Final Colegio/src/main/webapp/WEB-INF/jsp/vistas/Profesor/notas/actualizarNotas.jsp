...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<h1 class="my-4">Modificar Notas</h1>
			...
			<div class="col-lg-9">
				<div class="row">
					<div class="container">
						<form action="http://localhost:8080/colegio/formularioactualizarnotaP"
							method="post">
						...
						<c:forEach items="${lista}" var="notas">
							<div class="form">
								<form action="http://localhost:8080/colegio/actualizarnotaP"
									method="post">
