...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<h1 class="my-4">Borrar Profesor</h1>
			...
			<div class="col-lg-9">
				<div class="row">
					<div class="container">
						<form
							action="http://localhost:8080/colegio/formularioborrarprofesorA"
							method="post">
							<div class="form-group">
								<label for="id">Id Profesor</label> <input type="text" id="id"
									name="id" class="form-control">
							</div>
							<div class="form-group">
								<label for="nombre">Nombre Profesor</label> <input type="text"
						...
						<c:forEach items="${lista}" var="profesor">
							<div class="form">
								<form action="http://localhost:8080/colegio/borrarprofesorA"
									method="post">

									<label for="id">Id Profesor</label> <input type="text"
										id="id" name="id" value="${profesor.id}" readonly> <label
										for="nombre">Nombre Profesor</label> <input type="text"
										id="nombre" name="nombre" value="${profesor.nombre}"
										readonly><br> <label for="curso">Curso</label> <input
										type="text" id="curso" name="curso"
										value="${profesor.curso}" readonly>
										 <input
						...
						<c:if test="${resultado == 1 }">
							<b>Profesor borrada correctamente correctamente</b>
						</c:if>
					</div>
				</div>
			</div>
