			...
			<div class="col-lg-3">
				...
				<div class="list-group">
					<a href="http://localhost:8080/colegio/listadonotasA">Listar
						...
						Notas</a> <a href="http://localhost:8080/colegio/formularioborrarnotaA">Borrar
						Notas</a>
				</div>
			</div>
			<div class="col-lg-9">
				<div class="row">
					<div class="container">
						<form action="http://localhost:8080/colegio/formularioborrarnotaA"
							method="post">
						...
						<c:forEach items="${lista}" var="nota">
							<div class="form">
								<form action="http://localhost:8080/colegio/borrarnotaA"
									method="post">

									<input class="hidden" type="text" name="idNota" id="idNota"
										value="${nota.id}"> <label for="nombre">Alumno</label>
									<input type="text" id="nombre" name="nombre"
										value="${ nota.nombreAlumno}" readonly> <label
										for="asignatura">Asignatura</label> <input type="text"
										id="asignatura" name="asignatura"
										value="${ nota.nombreAsignatura}" readonly> <br>
									<label for="nota">Nota</label> <input type="text" id="nota"
										name="nota" value="${ nota.nota}" readonly> <label
										for="fecha">Fecha</label> <input type="date" id="fehca"
										name="fecha" value="${ nota.fecha}" readonly> <input
