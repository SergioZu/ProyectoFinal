...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<h1 class="my-4">Actualizar Temas</h1>
			...
			<div class="col-lg-9">
				<div class="row">
					<div class="container">
						<form
							action="http://localhost:8080/colegio/formularioactualizartemasA"
							method="post">
						...
						<c:forEach items="${lista}" var="temas">
							<div class="form">
								<form action="http://localhost:8080/colegio/actualizartemaA"
									method="post">
									<input class="hidden" type="text" name="idTema" id="idTema"
										value="${temas.id}"><label for="nota">Nombre </label>
									<input type="text" id="nombre" name="nombre"
										value="${ temas.nombre}"> <label for="asignaturas">Asignaturas</label>
