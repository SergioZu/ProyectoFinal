...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<h1 class="my-4">Listado Asignaturas</h1>
				<div class="list-group">
					 <a href="http://localhost:8080/colegio/listadoasignaturasA">Listar Asignaturas</a>
					  <a href="http://localhost:8080/colegio/insertarasignaturaA">Insertar Asignaturas</a>
					  <a href="http://localhost:8080/colegio/formularioactualizarasignaturaA">Modificar Asignaturas</a>
					  <a href="http://localhost:8080/colegio/formularioborrarasignaturaA">Borrar Asignaturas</a>
				</div>
			</div>
			<div class="col-lg-9">
				<div class="row">
					<div class="container">
						<form action="http://localhost:8080/colegio/listadoasignaturasA"
							method="post">
