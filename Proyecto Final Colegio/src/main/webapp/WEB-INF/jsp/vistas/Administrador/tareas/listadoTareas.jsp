	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				...
				<div class="list-group">
					<a href="http://localhost:8080/colegio/listadotareasA">Listar
						Tareas</a> <a href="http://localhost:8080/colegio/insertartareasA">Insertar
						Tareas</a> <a
			...
			<div class="col-lg-9">
				<div class="row">
					<div class="container">
						<form action="http://localhost:8080/colegio/listadotareasA"
							method="post">
							...
							<div class="form-group">
								<label for="titulo"> Titulo Tema</label> <input type="text"
									id="titulo" name="titulo" class="form-control">
							</div>
							<div class="form-group">
								<label for="tema"> Nombre Tema</label> <input type="text"
									id="tema" name="tema" class="form-control">
							</div>
