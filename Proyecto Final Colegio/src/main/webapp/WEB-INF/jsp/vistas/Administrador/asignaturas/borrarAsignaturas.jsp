...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<h1 class="my-4">Borrar Asignatura</h1>
			...
			<div class="col-lg-9">
				<div class="row">
					<div class="container">
						<form
							action="http://localhost:8080/colegio/formularioborrarasignaturaA"
							method="post">
						...
						<c:forEach items="${lista}" var="asignatura">
							<div class="form">
								<form action="http://localhost:8080/colegio/borrarasignaturaA"
									method="post">

									<label for="id">Id Asignatura</label> <input type="text"
										id="id" name="id" value="${asignatura.id}" readonly> <label
										for="nombre">Nombre Asignatura</label> <input type="text"
										id="nombre" name="nombre" value="${asignatura.nombre}"
										readonly><br> <label for="curso">Curso</label> <input
										type="text" id="curso" name="curso"
										value="${asignatura.curso}" readonly> <label
										for="tasa">Tasa</label> <input type="text" id="tasa"
										name="tasa" value="${asignatura.tasa}" readonly> <input
