		...
		<div class="row">
			...
			<div class="col-lg-9">
				<div class="row">
					<div class="container">
						<form
							action="http://localhost:8080/colegio/formularioeliminaralumnoA"
							method="post">
						...
						<c:forEach items="${lista}" var="alumno">
							<div class="form">
								<form action="http://localhost:8080/colegio/eliminaralumnoA"
									method="post">

									<label for="id">Id Alumno</label> <input type="text" id="id"
										name="id" value="${alumno.id}" readonly> <label
										for="nombre">Nombre Alumno</label> <input type="text"
										id="nombre" name="nombre" value="${alumno.nombre}" readonly><br>

									<label for="nombre">Municipio</label> <input type="text"
										id="municipio" name="municipio" value="${alumno.municipio}"
										readonly> <input type="submit" value="Eliminar">
								</form>
							</div>
						</c:forEach>
