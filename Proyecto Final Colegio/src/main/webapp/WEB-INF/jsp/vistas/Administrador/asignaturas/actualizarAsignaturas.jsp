...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				<h1 class="my-4">Modificar Asignatura</h1>
			...
			<div class="col-lg-9">
				<div class="row">
					<div class="container">
						<div class="container">
							<form
								action="http://localhost:8080/colegio/formularioactualizarasignaturaA"
								method="post">
								...
								<div class="form-group">
									<label for="nombre">Nombre Asignatura</label> <input
							...
							<c:forEach items="${lista}" var="asignatura">
								<div class="form">
									<form
										action="http://localhost:8080/colegio/actualizarasignaturaA"
										method="post">
